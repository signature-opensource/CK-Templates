...
namespace CK.DB.NAME_PLACE_HOLDER_DOT.Tests
{
    ...
    {
        static NAME_PLACE_HOLDER_CAMELCASETable NAME_PLACE_HOLDER_CAMELCASETable => TestHelper.CreateAutomaticServices().GetRequiredService<NAME_PLACE_HOLDER_CAMELCASETable>();
